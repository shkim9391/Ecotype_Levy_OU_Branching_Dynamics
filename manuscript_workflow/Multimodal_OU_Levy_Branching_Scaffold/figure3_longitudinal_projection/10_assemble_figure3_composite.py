...
A_PNG = PANELS_DIR / "Figure3A_patient_trajectories.png"
B_PNG = PANELS_DIR / "Figure3B_group_average_trajectories.png"
C_PNG = PANELS_DIR / "Figure3C_displacement_distributions.png"
D_PNG = PANELS_DIR / "Figure3D_jump_candidates.png"

OUT_PNG = FINAL_DIR / "Figure3_therapy_induces_contraction_persistence_escape.png"
OUT_PDF = FINAL_DIR / "Figure3_therapy_induces_contraction_persistence_escape.pdf"
...
LEFT_W = (CANVAS_W - 2 * MARGIN - GAP_X) // 2
RIGHT_W = LEFT_W
...
def main() -> None:
    ...
    A2 = fit_panel(A, LEFT_W, TOP_H)
    B2 = fit_panel(B, RIGHT_W, TOP_H)
    C2 = fit_panel(C, LEFT_W, BOT_H)
    D2 = fit_panel(D, RIGHT_W, BOT_H)
    ...
    # panel boxes
    xL = MARGIN
    xR = MARGIN + LEFT_W + GAP_X
    yT = MARGIN
    yB = MARGIN + TOP_H + GAP_Y

    paste_centered(canvas, A2, xL, yT, LEFT_W, TOP_H)
    paste_centered(canvas, B2, xR, yT, RIGHT_W, TOP_H)
    paste_centered(canvas, C2, xL, yB, LEFT_W, BOT_H)
    paste_centered(canvas, D2, xR, yB, RIGHT_W, BOT_H)

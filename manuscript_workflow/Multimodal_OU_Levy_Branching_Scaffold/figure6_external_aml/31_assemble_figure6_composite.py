...
A_PNG = PANELS_DIR / "Figure6A_external_projection.png"
B_PNG = PANELS_DIR / "Figure6B_external_timepoint_organization.png"
C_PNG = PANELS_DIR / "Figure6C_external_calibration_metric.png"
D_PNG = PANELS_DIR / "Figure6D_calibration_summary.png"

OUT_PNG = FINAL_DIR / "Figure6_external_longitudinal_calibration.png"
OUT_PDF = FINAL_DIR / "Figure6_external_longitudinal_calibration.pdf"
...
BOT_LEFT_W = int((CANVAS_W - 2 * MARGIN - GAP_X) * 0.45)

...
meta_file = Path("/Ecotype_OU_Branching/GSE235063/derived_dx_primary_training/rebuilt_transfer_expression/gse235063_malignant_pseudobulk_sample_metadata.csv")

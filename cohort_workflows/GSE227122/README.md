...
ingestion of the GSE227122 dataset,
cell annotation and marker-based summary generation,
projection into the transferred ecotype framework,
comparison of projected structure across samples and timepoints,
compact plotting for strict-transfer presentation.

...
PRIMARY = Path("/Ecotype_OU_Branching/GSE235063/derived_dx_primary_training/dx_primary_training_allcells.h5ad")
SECONDARY = Path("/Ecotype_OU_Branching/GSE235923/derived_secondary_calibration/gse235923_dx_secondary_calibration_unlabeled_gexonly_autoname.h5ad")

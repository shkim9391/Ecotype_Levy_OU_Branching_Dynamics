...
PRIMARY_DIR = Path("/Ecotype_OU_Branching/GSE235063/derived_dx_primary_training")
SECONDARY_DIR = Path("/Ecotype_OU_Branching/GSE235923/derived_secondary_calibration")
